...
const c1: OhlcCandle = {
  open: 64800, high: 65150, low: 64750, close: 65100,
  pct_change: 0.463,
  body_ratio: 0.75,
  candle_range: 0.617,
};
const c2: OhlcCandle = {
  open: 65100, high: 65400, low: 65050, close: 65350,
  pct_change: 0.384,
  body_ratio: 0.714,
  candle_range: 0.538,
};
const c3: OhlcCandle = {
  open: 65350, high: 65850, low: 65300, close: 65750,
  pct_change: 0.612,
  body_ratio: 0.727,
  candle_range: 0.842,
};
...
describe("calcSimpleAverage (T1)", () => {
  ...
  it("returns abs() of a downtrend result (directional_agreement = -3)", () => {
    const down1: OhlcCandle = { ...c1, pct_change: -0.463, body_ratio: 0.75, candle_range: 0.617 };
    const down2: OhlcCandle = { ...c2, pct_change: -0.384, body_ratio: 0.714, candle_range: 0.538 };
    const down3: OhlcCandle = { ...c3, pct_change: -0.612, body_ratio: 0.727, candle_range: 0.842 };
