...
import { calcDollarRisk, calcLeverage, calcSlPrice, calcTpPrice } from '../src/execution.js';
...
describe('calcLeverage', () => {
  ...
  it('README §9 simulated cases', () => {
    ...
    // T-B: High 0.90% → 3x
    expect(calcLeverage(3, 0.9).leverage).toBe(3);
    // T-C: Moderate 2.80% → 1x
    expect(calcLeverage(3, 2.8).leverage).toBe(1);
